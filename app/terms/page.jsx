    ...
    return (
        <div className="container">
            ...
            <ul>
                ...
                <li>Los usuarios son los únicos responsables de mantener la confidencialidad de su contraseña de acceso y deberán asumir cualquier perjuicio derivado del quebrantamiento, revelación o mal uso de la misma.</li>
                <li>El proveedor podrá exigir a los usuarios la verificación de su dirección de correo electrónico y limitar o impedir el acceso y uso de la plataforma hasta que dicha verificación sea completada.</li>
                <li>Los usuarios deberán respetar en todo momento los derechos de terceros y se comprometen a colaborar activamente con el proveedor en la localización y denuncia de cualquier conducta que suponga una infracción de estos Términos y Condiciones o de las leyes de aplicación.</li>
                <li>Los usuarios son los únicos responsables de cualquier contenido que generen, transmitan, alojen, difundan, comuniquen, pongan a disposición, enlacen, incrusten o exhiban a través de la plataforma. Los usuarios deben cumplir rigurosamente con todas las leyes aplicables en materia de protección de datos, privacidad, derechos de intimidad e imagen y propiedad intelectual e industrial, exonerando al proveedor de cualquier reclamación en estas materias. En ningún caso el proveedor será responsable de las opiniones expresadas por los usuarios en la plataforma, ni de los contenidos enlazados, embebidos, generados o almacenados por los mismos en la plataforma, ni de las consecuencias derivadas de dichos contenidos, ni de la precisión, integridad, fiabilidad o legalidad de dichos contenidos. </li>
                <li>El proveedor podrá implementar las funcionalidades y usar las tecnologías que considere convenientes para evitar en la plataforma cualquier tipo de contenido que pueda resultar difamatorio, racista, sexista, xenófobo, discriminatorio, pornográfico, violento o que, de cualquier modo, atente a la moral, al orden público o a las buenas costumbres, o resulte claramente contrario a la ley.</li>
                <li>El proveedor podrá limitar el espacio en servidores (capacidad de almacenamiento) que puede ocupar con sus contenidos cada usuario registrado.</li>
                <li>Un usuario registrado podrá darse de baja de la plataforma, pero el proveedor se reserva el derecho de eliminar o conservar cualquiera de los contenidos enlazados, embebidos, generados o almacenados por él, así como el derecho a conservar sus datos personales anonimizados.</li>
                <li>El proveedor se reserva el derecho, a su entera discreción y en cualquier momento, de eliminar, retirar la publicación o rehusarse a publicar cualquier contenido enlazado, embebido, generado o almacenado por un usuario registrado, sin que dicho usuario registrado pueda exigir indemnización o compensación alguna.</li>
                <li>El proveedor se reserva el derecho de denegar, restringir, suspender o cancelar el acceso de un usuario registrado a la plataforma, así como de cancelar o eliminar su cuenta, a su entera discreción y en cualquier momento, si considera o sospecha que ha incumplido los Términos y Condiciones, o si la cuenta permanece inactiva durante un periodo determinado, sin que ello genere derecho a indemnización o compensación alguna.</li>
                <li>En ningún caso el proveedor será responsable del inadecuado funcionamiento de la plataforma o de cualquier tipo de perjuicio derivado de su uso. El proveedor no garantiza que la plataforma esté libre de errores, interrupciones, virus u otros elementos dañinos, y no será responsable por cualquier daño o pérdida que resulte del acceso o uso de la plataforma. El proveedor no será responsable, en ningún caso, de los daños indirectos, incidentales, especiales, punitivos, consecuentes o de cualquier otro tipo (incluidos, entre otros, la pérdida de beneficios, la pérdida de datos o la interrupción del servicio) que puedan derivarse del uso o la incapacidad de uso de la plataforma o de los contenidos ofrecidos por ella, incluso si el proveedor ha sido advertido de la posibilidad de tales daños.</li>
                <li>El proveedor podrá suspender o cerrar el registro de nuevos usuarios en la plataforma, de forma temporal o definitiva, si así lo requieren razones técnicas o de seguridad, sin que este hecho suponga reclamación o indemnización alguna.</li>
