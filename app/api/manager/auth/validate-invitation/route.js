// app/aiquiz/api/manager/auth/validate-invitation/route.js
...
/**
 * @swagger
 * /aiquiz/api/manager/auth/validate-invitation:
 *   post:
 *     tags:
 *       - Authentication
 *     summary: Validar token de invitación
 *     description: Valida si un token de invitación es válido y no ha expirado
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
